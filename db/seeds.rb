...
User.create([{ :fname => 'Roshan', :lname => 'Choxi', :phone_number => '+12245780974', :email => 'roshan.choxi@gmail.com', :company => "Groupon"}]) if User.where(:fname => 'Roshan').empty?
User.create([{ :fname => 'Jason', :lname => 'McCreary', :phone_number => '+15026403554', :email => 'jason@pureconcepts.net', :company => "ACME"}]) if User.where(:fname => 'Agam').empty?
